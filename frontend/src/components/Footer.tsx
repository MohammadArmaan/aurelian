    ...
    <footer className="mt-24 border-t border-border/60 bg-[oklch(0.95_0.012_85)]">
      <div className="container mx-auto px-6 py-20 grid md:grid-cols-4 gap-12">
        <div className="md:col-span-2">
          <div className="font-serif text-3xl">Aurelian<span className="text-accent">.</span></div>
          <p className="mt-4 text-muted-foreground max-w-md leading-relaxed">
            Heirloom furniture, made by hand. Designed to last lifetimes, sourced from the world's most respected ateliers.
          </p>
          <form
            onSubmit={(e) => { e.preventDefault(); if (email) { toast.success("Subscribed to the journal"); setEmail(""); } }}
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/shop">Seating</Link></li>
            <li><Link to="/shop">Tables</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/bookings">Trade program</Link></li>
