  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="hidden lg:block relative">
        ...
        <Link to="/" className="absolute top-8 left-8 text-white font-serif text-2xl">
          Aurelian.
        </Link>
        <div className="absolute bottom-12 left-12 right-12 text-white">
          <p className="font-serif text-3xl leading-tight max-w-md">
            "The furniture we live with should outlast the trends that surround it."
          </p>
        </div>
      </div>
      <motion.div
      ...
      >
        <div className="w-full max-w-md">
          <Link to="/" className="lg:hidden font-serif text-2xl block mb-12">
            Aurelian.
          </Link>
