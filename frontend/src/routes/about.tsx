      ...
      <section className="relative min-h-[60vh] flex items-end -mt-[88px]">
        ...
        <div className="relative container mx-auto px-6 pt-40 pb-20 text-white">
          ...
          <h1 className="font-serif text-5xl md:text-7xl max-w-3xl leading-[0.95]">
            Built slowly, in a quiet atelier outside Florence.
          </h1>
        </div>
      </section>
        ...
        {[
          {
            y: "1972",
            t: "A single chair",
            d: "Our founder, Marco Aurelian, began with a single dining chair commissioned for a friend's villa. Word travelled.",
          },
          {
            y: "1998",
            t: "The atelier",
            d: "We outgrew our garage. A 12,000 sqft restored mill became our home — half showroom, half workshop.",
          },
          {
            y: "2014",
            t: "The trade program",
            d: "Architects and designers began specifying our pieces. We formalized our trade program and introduced custom commissions.",
          },
          {
            y: "Today",
            t: "Heirlooms, modern",
            d: "We ship to 47 countries. Every piece still passes through hands we know by name.",
          },
        ].map((s, i) => (
          <motion.div
            key={i}
