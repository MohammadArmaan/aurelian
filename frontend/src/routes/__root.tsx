  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-4 text-muted-foreground">This page has drifted into the atelier.</p>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Something went wrong. The backend at localhost:8000 may be offline.</p>
        <div className="mt-6 flex justify-center gap-2">
          <button onClick={() => { router.invalidate(); reset(); }}
            className="rounded-md bg-primary px-4 py-2 text-sm text-primary-foreground">Try again</button>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Aurelian — Heirloom luxury furniture" },
      { name: "description", content: "Aurelian crafts heirloom furniture for collectors, designers and contractors. Editorial pieces in walnut, brass and ivory." },
    ],
    links: [
