    ...
    <div>
      ...
      <section className="relative min-h-[70vh] flex items-center my-16">
        ...
        <div className="relative container mx-auto px-6 text-white max-w-2xl">
          ...
          <h2 className="font-serif text-4xl md:text-6xl leading-tight">
            ...
            <br />
            Honest materials.
            <br />A century of patina.
          </h2>
          <Button
            variant="outline"
            className="mt-10 bg-transparent border-white text-white hover:bg-white hover:text-black"
            asChild
          >
            <Link to="/about">
              Our atelier <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
          </Button>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 py-24">
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              q: "Every Aurelian piece feels like it's been in the family for generations.",
              a: "— Architectural Digest",
            },
            {
              q: "The most quietly luxurious furniture we specify, season after season.",
              a: "— Studio Lavín, Madrid",
            },
            {
              q: "Heirlooms in the making. Worth the wait, worth the price.",
              a: "— The Modern House",
            },
          ].map((t, i) => (
            <motion.figure
        ...
        <div className="bg-[oklch(0.18_0.012_60)] text-[oklch(0.97_0.012_85)] flex items-center p-12 md:p-20">
          <div>
            ...
            <h2 className="font-serif text-4xl md:text-5xl leading-tight">
              For contractors, architects & studios.
            </h2>
            <p className="mt-6 text-white/70 leading-relaxed max-w-md">
              Custom finishes, dedicated lead times, and account pricing for your projects. Submit a
              brief and we'll respond within 48 hours.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Button asChild variant="secondary">
                <Link to="/bookings">Request a booking</Link>
              </Button>
              <Button asChild variant="ghost" className="text-white hover:bg-white/10">
                <Link to="/contractor">Contractor portal</Link>
              </Button>
            </div>
            <div className="mt-12 grid grid-cols-3 gap-6 text-sm">
              {[
                { i: Award, t: "Trade pricing" },
                { i: Hammer, t: "Custom commissions" },
                { i: Truck, t: "White-glove delivery" },
              ].map(({ i: Icon, t }) => (
                <div key={t}>
    ...
    <section className="container mx-auto px-6 py-24">
      <div className="flex items-end justify-between mb-16 flex-wrap gap-4">
        ...
        {cta && (
          <Link
            to={cta.to}
            className="text-sm uppercase tracking-widest hover:text-accent flex items-center gap-2"
          >
  ...
  return (
    <div className="col-span-full text-center py-16 border border-dashed border-border/60">
      <p className="text-muted-foreground">
        No products yet. Connect your backend at <code>localhost:8000</code> to populate the
        collection.
      </p>
    </div>
  );
